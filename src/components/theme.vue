<!-- 切换主题色  -->
<template>
  <div id="list" class="handle-theme">
    <el-color-picker @change="changeThemeColor" v-model="colors.primary"></el-color-picker>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    changeThemeColor(val) {
			this.$store.commit('theme/changeThemeColor',val)
      // if (!e) return
      // this.primaryColor = e
